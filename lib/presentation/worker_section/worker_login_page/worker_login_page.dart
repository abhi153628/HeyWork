// lib/presentation/worker_section/login_screen/login_screen_worker.dart
...
class _WorkerLoginScreenState extends State<WorkerLoginScreen> {
  ...
  Future<void> _verifyPhoneNumber() async {
    ...
    try {
      // Verify phone for worker user type
  ...
  Future<void> _verifyOTP() async {
    ...
    try {
      ...
      if (userCredential.user != null) {
        // Check if user is really a worker
        final userType = await _authService.getUserType();
        
        if (userType == 'worker') {
          // Store user type locally
          await _authService.storeUserType('worker');
          
          // Navigate to worker main screen
          ...
          setState(() {
            _isLoading = false;
            _errorMessage = 'This number is registered as a hirer, not a worker. Please use hirer login.';
          });
          
          _showSnackBar('This number is registered as a hirer, not a worker. Please use hirer login.', isError: true);
        }
      } else {
                ...
                child: Form(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Center(
                        child: Text(
                          "Log in to access your worker account",
                          style: GoogleFonts.roboto(
