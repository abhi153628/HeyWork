...
class HirerLoginScreen extends StatefulWidget {
  ...
  @override
  State<HirerLoginScreen> createState() => _HirerLoginScreenState();
}
                    ...
                    child: Form(
                      ...
                      child: Column(
                        ...
                        children: [
                                  ...
                                  child: Row(
                                    children: [
                                      ...
                                      ClipRRect(borderRadius: BorderRadius.circular(3),
                                        child: Image.asset(
                                          'asset/Flag_of_India.png', // Keep the same flag asset
                          ...
                          // OTP Input field - Show only when OTP is sent
                          if (_otpSent) ...[
